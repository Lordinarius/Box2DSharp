...
namespace Box2DSharp.Collision
{
    ...
    public static partial class CollisionUtils
    {
        ...
        public static F FindMaxSeparation(
            out int edgeIndex,
            PolygonShape poly1,
            in Transform xf1,
            PolygonShape poly2,
            in Transform xf2)
        {
            ...
            Span<V2> n1s = poly1.Normals;
            Span<V2> v1s = poly1.Vertices;
            Span<V2> v2s = poly2.Vertices;
            ...
            for (var i = 0; i < count1; ++i)
            {
                ...
                {
                    //var sij = V2.Dot(n, v2s[j] - v1); // inline
            ...
            in Transform xf2)
        {
            ...
            var y = new V2(xf1.Rotation.Cos * n1.X - xf1.Rotation.Sin * n1.Y, xf1.Rotation.Sin * n1.X + xf1.Rotation.Cos * n1.Y);
            var normal1 = new V2(xf2.Rotation.Cos * y.X + xf2.Rotation.Sin * y.Y, -xf2.Rotation.Sin * y.X + xf2.Rotation.Cos * y.Y);
            ...
            {
                var dot = V2.Dot(normal1, normals2[i]);
                if (dot < minDot)
                {
                    minDot = dot;
                    index = i;
            ...
            in Transform xfB)
        {
            ...
            byte flip;
            const F k_tol = 0.1f * Settings.LinearSlop;
            ...
            var localNormal = MathUtils.Cross(localTangent, F.One);
            var planePoint = F.Half * (v11 + v12);

            var tangent = MathUtils.Mul(xf1.Rotation, localTangent);
            var normal = MathUtils.Cross(tangent, F.One);

            v11 = MathUtils.Mul(xf1, v11);
            v12 = MathUtils.Mul(xf1, v12);

            // Face offset.
            var frontOffset = V2.Dot(normal, v11);

            // Side offsets, extended by polytope skin thickness.
            var sideOffset1 = -V2.Dot(tangent, v11) + totalRadius;
            var sideOffset2 = V2.Dot(tangent, v12) + totalRadius;
            ...
            {
                var separation = V2.Dot(normal, clipPoints2[i].Vector) - frontOffset;
