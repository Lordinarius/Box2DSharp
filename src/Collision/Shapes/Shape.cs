...
namespace Box2DSharp.Collision.Shapes
{
    ...
    public abstract class Shape
    {
        ...
        public F Radius { get; internal set; }
        ...
        public abstract bool TestPoint(in Transform transform, in V2 point);
        ...
        public abstract void ComputeMass(out MassData massData, F density);
    }
}