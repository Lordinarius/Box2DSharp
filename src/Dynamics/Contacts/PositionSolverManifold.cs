    ...
    public struct PositionSolverManifold
    {
        ...
        public void Initialize(in ContactPositionConstraint pc, in Transform xfA, in Transform xfB, int index)
        {
            ...
            case ManifoldType.Circles:
            {
                ...
                var pointB = new V2(x, y);

                Normal = pointB - pointA;
                Normal.Normalize();
                Point = F.Half * (pointA + pointB);
                Separation = V2.Dot(pointB - pointA, Normal) - pc.RadiusA - pc.RadiusB;
            }
                break;
            ...
            case ManifoldType.FaceA:
            {
                ...
                var clipPoint = new V2(x, y);

                Separation = V2.Dot(clipPoint - planePoint, Normal) - pc.RadiusA - pc.RadiusB;
                Point = clipPoint;
            }
                break;
